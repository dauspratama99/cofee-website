	...
	<div class="container">
		<div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
			<div class="col-md-12 ftco-animate">
				...
				<br>
				<p class="caps"><a href="https://api.whatsapp.com/send?phone=6281380825399&text=Halo... Saya ingin membeli biji kopi ini!" class="btn" style="background-color:#F96D00; color:white;"><i class="fa fa-whatsapp"></i> Hubungi Kami</a></p>
			</div>
		</div>
	</div>
</div>
					...
					<div class="blog-entry">
						...
						<div class="text" style="min-height: 18em;">
							...
							<div class="mx-auto" class="text-align: center;">
								<a href="https://api.whatsapp.com/send?phone=6281380825399&text=Halo... Saya ingin membeli biji kopi ini!" class="text-center btn btn-primary btn-block" target="_blank"> <i class="fa fa-whatsapp"></i> Order Now</a>
